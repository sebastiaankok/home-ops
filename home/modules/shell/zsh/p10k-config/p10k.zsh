# Generated by Powerlevel10k configuration wizard on 2024-01-30 at 01:02 CET.
...
() {
  ...
  # Prompt colors for Catppuccin Mocha
  local grey='#6E6A86'
  local red='#F28FAD'
  local yellow='#F9E2AF'
  local blue='#89B4FA'
...
# Check if ~/.aider_model exists and export its value as AIDER_MODEL
if [[ -f "$HOME/.openrouter_model" ]]; then
  export AIDER_MODEL=$(cat "$HOME/.openrouter_model")
fi

# Aider settings
export AIDER_DARK_MODE="True"
export AIDER_CHAT_LANGUAGE="english"
export AIDER_COMMIT_LANGUAGE="english"
